...
<!-- Start of footer -->
    ...
    <div id="carModal" class="modal">
        <div class="modal-content">
            ...
            <p><strong>Status:</strong> <span id="modalCarStatus"></span></p>
            <div class="modal-features">
                <h3>Addons/Features:</h3>
                <ul id="modalCarFeatures">
                    <!-- Features will be populated here -->
                </ul>
            </div>
            <div class="modal-actions">
                <button id="modalRentButton" class="btn" style="width: auto;">Rent Now</button>
            </div>
        </div>
    </div>
